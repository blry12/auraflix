...
prop_dict = {'default': 'afm_%s_default', 'edited': 'afm_%s_edited', 'shortcut_folder': 'afm_%s_shortcut_folder'}
timeout = 60
...
main_menu_items = {'RootList': {'name': 32457, 'iconImage': 'afm', 'mode': 'navigator.main', 'action': 'RootList'},
