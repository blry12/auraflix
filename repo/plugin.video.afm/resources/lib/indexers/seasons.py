...
afm_str, trakt_str, season_str, watched_str, unwatched_str, season_str = ls(32036), ls(32037), ls(32537), ls(32642), ls(32643), ls(32537)
	...
	def _process():
		...
		for item in season_data:
			try:
				...
				set_properties({'totalepisodes': string(episode_count), 'watchedprogress': string(progress), 'afm.extras_params': extras_params, 'afm.options_params': options_params})
				if is_external:
