...
class SourcesPlayback(BaseDialog):
	...
	def set_scraper_properties(self):
		...
		self.setProperty('flag_highlight', self.get_setting('afm.scraper_flag_identify_colour', 'FF7C7C7C'))
		self.setProperty('result_highlight', self.get_setting('afm.scraper_result_identify_colour', 'FFFFFFFF'))
