...
destination_check = translate_path('special://home/addons/plugin.video.afm/')

def get_versions():
	result = requests.get('https://github.com/Tikipeter/tikipeter.github.io/raw/main/packages/afm_version')
...
def update_addon(new_version, action):
	...
	zip_name = 'plugin.video.afm-%s.zip' % new_version
	...
	shutil.rmtree(osPath.join(home_addons_dir, 'plugin.video.afm'))
